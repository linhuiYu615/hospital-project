<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入就诊时间" style="width: 200px" v-model="week"></el-input>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="week" label="工作时间"></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        ...
        <el-form-item prop="week" label="看病日期">
          <el-select v-model="form.week"  placeholder="请输入看病日期" style="width: 100%">
